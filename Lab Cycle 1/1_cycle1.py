...
def calculate(num):
    ...
    temp=temp//10
    diff=odd-evn
    return sum, revnum, diff               # difference of odd position product and even position product

def display():
    sum, revnum, diff = calculate(num)
    print('Sum : ',sum)                        # printing sum of digit
    print('Reverse number : ',revnum)          # printing reverse number
    print('Difference between the product of digits at the odd position and the product of digits at the even position : ',diff)  
